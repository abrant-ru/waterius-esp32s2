...
#define ULP_BATT_EN_IO          10  // Battery enable GPIO number
#define ULP_BUTTON_IO           6   // Button GPIO number

#define ULP_PULL_UP             5   // Pull-up GPIO number
#define ULP_PWR                 18  // Power GPIO number

#define ULP_CH0_IO              4   // CH0 GPIO number
#define ULP_CH0_ADC_CHANNEL     3   // ADC_CHANNEL_2, GPIO3 on ESP32-S2
#define ULP_CH0_LED             1   // CH0 LED GPIO number
#define ULP_CH0_OUT             19  // CH0 Output relay&LED GPIO number

#define ULP_CH1_IO              3   // CH1 GPIO number
#define ULP_CH1_ADC_CHANNEL     2   // ADC_CHANNEL_6, GPIO7 on ESP32-S2
#define ULP_CH1_LED             7   // CH1 LED GPIO number
#define ULP_CH1_OUT             20  // CH1 Output relay&LED GPIO number
